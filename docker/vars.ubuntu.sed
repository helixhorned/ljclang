s/@DISTRO_IMAGE@/ubuntu:jammy-20231211.1/g
...
s/$pkg_libclang_dev/libclang-15-dev/g
s/$pkg_luarocks/luarocks/g
s/$pkg_liblua51_dev/liblua5.1-0-dev/g
s/@llvm_version@/15.0.6/g
s|@llvm_incdir@|/usr/lib/llvm-15/include|g
s|@llvm_libdir@|/usr/lib/llvm-15/lib|g
s/@SHELL@/bash/g
